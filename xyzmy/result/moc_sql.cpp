...
**
** Created: Wed Jan 6 19:13:33 2016
**      by: The Qt Meta Object Compiler version 62 (Qt 4.7.3)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../working/sql.h"
...
static const char qt_meta_stringdata_SQL[] = {
    "SQL\0"
};

const QMetaObject SQL::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SQL,
      qt_meta_data_SQL, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SQL::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SQL))
